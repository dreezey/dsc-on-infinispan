...
public class GetSessionReturn {
    ...
    private List<GetSessionDataReturn> data;

    public GetSessionReturn() {
    }

    public GetSessionReturn(int version, List<GetSessionDataReturn> data) {
    ...
    public List<GetSessionDataReturn> getData() {
        return data;
    }

    public void setData(List<GetSessionDataReturn> data) {
        this.data = data;
    }
}
