...
public class TerminateSessionReturn extends ModifyResponseBase {

    public TerminateSessionReturn() {
    }

    public TerminateSessionReturn(int result, int version, int stackDepth, boolean clearOnReadDataPresent) {
        this.result = result;
